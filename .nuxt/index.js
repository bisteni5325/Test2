...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Gari","description":"El seguro inteligente basado en cómo y cuánto conduces","htmlAttrs":{"lang":"es"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1.0, maximum-scale=1, minimum-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_2d424cfc === 'function') {
    await nuxt_plugin_plugin_2d424cfc(app.context, inject)
  }
